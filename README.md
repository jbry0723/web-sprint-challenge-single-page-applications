...
A: "useRouteMatch" is a hook used to create a "placeholder" of the url so that it can be referenced without typing out the entire URL.

1. How would you explain form validation to someone who has never programmed before?
A. Form validation is a process to make sure the information entered by the person using a website matches the format the web developer is expecting; such as an email needing an "@" and ".com" somewhere in it, or a password needing a certain amount of characters.

1. In 1-2 sentences, define end to end testing.
A. End to end testing is a type of testing that tests the entire webpage by simulating all the ways a user can interact with that webpage.
